...
function setup(){
  ...
  trex.setCollider("rectangle",0,0,100,95);
  trex.debug = false;
...
function draw(){
  ...
  if (estadoJogo === JOGAR){
    ...
    pontuacao = Math.round(frameCount*0.1);
    
    //Toca som de Check Point a cada 100 pontos
...
function gerarObstaculos(){
  if(frameCount % 120 === 0){
    ...
    obstaculo.velocityX = -(2 + 3*pontuacao/100); 
